...
const Contacts = ({setChat}) => {
    ...
    const [chats, setChats] = useState([
        {name:'User 1', id:'1',lastMsg:'this is my last message are you hearing ????', image:'https://cdn.pixabay.com/photo/2015/03/04/22/35/head-659651_960_720.png'},
            ...
            <div className="contacts_persons">
                {
                    chats.map(elem => {
                        return(
                            <div onClick={() => setChat(elem)} className="contacts_person">
